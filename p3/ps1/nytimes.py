...
def article_overview(kind, period):
    ...
    urls =[]
    for popular in data:
        # print json.dumps(popular, indent=4, sort_keys=True)
        titles.append({
...
def test():
    #popular_viewed_1 = get_popular(None, 'viewed', 1)
    #popular_viewed_1 = json.dumps(popular_viewed_1["results"], indent=4, sort_keys=True)
    #print popular_viewed_1
    #open('popular-viewed-1.json', 'w').write(popular_viewed_1 + '\n')
