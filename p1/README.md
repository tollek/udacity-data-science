...
1.1 Which statistical test did you use to analyze the NYC subway data? Did you use a one-tail or a two-tail P value? What is the null hypothesis? What is your p-critical value?
    ...
    For non-normal distribution I chose Mann–Whitney U test:
      ...
      HA: Rideship samples for rainy and non-rainy days come from different population and one of the samples
...
2.3 Why did you select these features in your model? We are looking for specific reasons that lead you to believe that the selected features will contribute to the predictive power of your model.
    ...
    Without other weather removed features I finally got a model with rain > 0.
...
2. Analysis, such as the linear regression model or statistical test.
      ...
      - mixed features e.g. (unit + rain). There is a chance that the weather had different impact
        on stations/days/hours etc. Such effects can be found only if we build 2, 3, 4- basic features
        mixes.
